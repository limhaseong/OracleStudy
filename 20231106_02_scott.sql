...
FROM TBL_STUDENTS;
/*
moon	문정환	010-9999-9999	제주도 서귀포시
wool	정한울	010-2222-2222	서울 강남구
*/
...
--○ 실습 테이블 생성(TBL_상품)           --실습을 위해 한글 테이블 생성
CREATE TABLE TBL_상품
( 상품코드      VARCHAR2(20)
, 상품명        VARCHAR2(100)
, 소비자가격    NUMBER
...
-- ① INSERT -> TBL_입고 대상으로 수행
--    INSERT INTO TBL_입고(입고번호, 상품코드, 입고일자, 입고수량, 입고단가)
--    VALUES(1, 'H001', 'SYSDATE', 30, 400);

-- ② UPDATE -> TBL_상품 대상으로
--    UPDATE TBL_상품
--    SET 재고수량 = 기존재고수량 + 입고수량
--    WHERE 상품코드 = 'H001';
