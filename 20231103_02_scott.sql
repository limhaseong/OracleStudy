...
SELECT FN_WORKYEAR(IBSADATE), NAME, IBSADATE
FROM TBL_INSA;
/*
25년
22년 11개월
...
SELECT NUM, NAME, FN_WORKYEAR(IBSADATE), TRUNC(MONTHS_BETWEEN(SYSDATE, IBSADATE)) - TRUNC(MONTHS_BETWEEN(SYSDATE, IBSADATE) /12) *12
FROM TBL_INSA;
...
-- 프로시저 생성 후 실행(호출)
EXEC PRC_SUNGJUK_INSERT(1, '이이이', 30, 40, 50);
EXEC PRC_SUNGJUK_INSERT(2, '라라라', 90, 80, 70);
EXEC PRC_SUNGJUK_INSERT(3, '하하하', 10, 20, 30);
EXEC PRC_SUNGJUK_INSERT(4, '하하하', 50, 90, 35);

SELECT *
FROM TBL_SUNGJUK;
/*
1	이이이	30	40	50	120	40	F
2	라라라	90	80	70	240	80	B
3	하하하	10	20	30	60	20	F
4	하하하	50	90	35	175	58.3	E
*/

EXEC PRC_SUNGJUK_UPDATE(4, 100, 50, 90);
SELECT *
FROM TBL_SUNGJUK;
/*
1	이이이	30	40	50	120	40	F
2	라라라	50	50	50	150	50	F
3	하하하	10	20	30	60	20	F
4	하하하	100	50	90	240	80	B
*/
